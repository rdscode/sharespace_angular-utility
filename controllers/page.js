...
angular.module('fusePumpAngularApp').controller('ModalCtrl', function ($scope, $modal, $log) {
...
angular.module('fusePumpAngularApp').controller('ModalInstanceCtrl', function ($scope, $modalInstance, items) {
